...
public class AndroidDownload {
    ...
    public AndroidDownload(Context context, String url) {
        this(context, url, getFileNameByUrl(url));
    }

    public AndroidDownload(Context context, String url, String name) {
        this.context = context;
        this.url = url;
        this.name = name;
    }

    public AndroidDownload setListener(AndroidDownloadManagerListener listener) {
